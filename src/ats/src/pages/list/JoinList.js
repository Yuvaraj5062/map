    ...
    const columns = [
        ...
        },
        {
            ...
            formatter: (cellContent, row) => {
                ...
                return (
                  <label>  {row.c.O_Join_Date?seldate.format('DD-MM-yyyy'):row.c.O_Join_Date}</label>
                );
              },
        },
        {
            ...
            formatter: (cellContent, row) => {
               // var offdate = row.c.O_Off_Date;
                ...
                return (
                  <label>  {row.c.O_Join_Date?offdate.format('DD-MM-yyyy'):row.c.O_Join_Date} </label>
                );
              },
        },
        {
            ...
            formatter: (cellContent, row) => {
               // var startdate = row.c.O_Join_Date;
                ...
                //console.log(startdate,"startdate",row.c.O_Join_Date)
                return (
