...
import { deleteTeam, getTeamList, getTeamModal, setUpdateTeam } from '../../../redux/teammaster/actions';
...
const ViewTeam = () => {
  ...
  ////console.log(records, 'join list');
    ...
    function onUpdateRecord(row , id) {    
        dispatch( setUpdateTeam(row) );
        dispatch( getTeamModal() );
    }
