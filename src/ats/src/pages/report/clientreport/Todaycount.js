   ...
   const NoDataIndication = () => (
      ...
      // var getUsername = loginDetails.Username;
       const downloadReport = (row) => {
              ...
              link.href = urlpattern + `TodayReport?username=${loginDetails.Username}&filetype=${'pdf'}`;
              link.setAttribute('download', 'TodaycountReport.pdf'); //or any other extension
...
const Todaycount = () => {
   ...
   var getUsername = loginDetails.Username;
    useEffect(() => {
        dispatch( getTodayReportList(getUsername));
