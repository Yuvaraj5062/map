...
import { getActiveRequirementList } from '../../../../redux/actions';
    ...
    const [file, setFile] = useState(null);
      const handleExcelUploadSubmit = async e => {
        ...
        if(res.data.Message!=="0-Records Added"){
          ...
          dispatch(getActiveRequirementList());
          //uploadToogle();
        ...
        <ModalFooter>
          ...
          <Button color="primary" onClick={uploadToogle}>Cancel</Button>
                ...
                <Col md={6}>
                    <PageTitle
                      breadCrumbItems={[
                          { label: 'Dashboard/ViewActieRequirementList', path: '/ViewActieRequirementList', active: true },
                      ]}
                    />
                </Col>
...
const ViewRequirement = (props) => {
  ...
  // }
  //let records=[];
   let records = useSelector((state) => state.PendingApproval.activerequiremenet || []) ;
