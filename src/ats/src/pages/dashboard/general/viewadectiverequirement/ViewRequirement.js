...
import { getDeActiveRequirementList } from '../../../../redux/actions';
...
const TableWithSearch = (props) => {
  ...
  const NoDataIndication = () => (
    ...
    const UPLOAD_ENDPOINT = `${urlpattern}RequirementUpload?username=${username}`;
    ...
    const handleExcelUploadSubmit = async (e) => {
        ...
        if (res.data.Message !== '0-Records Added') {
            ...
            dispatch(getDeActiveRequirementList());
            //uploadToogle();
            ...
            <Modal isOpen={uploadReq} toggle={uploadToogle} className={className}>
                <form>
                                ...
                                <form onSubmit={handleExcelUploadSubmit}>
                                    <Row>
                                        <Col lg={12} className="mb-5">
                                            {' '}
                                            <h5>
                                                <a href={requirementFile} download="Requirement.xlsx">
                                                    Download Requirement sample data file{' '}
                                                    <FeatherIcon.Download></FeatherIcon.Download>
                                                </a>
                                            </h5>
                                        </Col>
                                        <Col lg={8}>
                                        ...
                                        <Col lg={4}>
                                            <button disabled={uploadButton} className="btn btn-primary" type="submit">
                                                Upload File
                                            </button>
                                        </Col>
                    ...
                    <ModalFooter>
                        ...
                        <Button color="primary" onClick={uploadToogle}>
                            Cancel
                        </Button>
                    </ModalFooter>
                </form>
                        ...
                        <Row className="page-title">
                            <Col md={6}>
                                <PageTitle
                                    breadCrumbItems={[
                                        {
                                            label: 'Dashboard/DeActieRequirementList',
                                            path: '/ViewActieRequirementList',
                                            active: true,
                                        },
                                    ]}
                                />
...
const ViewRequirement = (props) => {
    ...
    let records = useSelector((state) => state.PendingApproval.deactiverequiremenet || []);
                    ...
                    <div className="col-sm-12">
                        ...
                        <TabContent className="req-tab-content" activeTab={activeTab}>
                            <TabPane tabId="1">
                                ...
                                <Col sm="12">
                                    <ShowRequirement
                                        viewSingleRequirement={viewSingleRequirement}
                                        goBackToRequirement={goBackToRequirement}
                                    />
                                </Col>
                            </TabPane>
                            <TabPane tabId="2">
            ...
            <Modal isOpen={modal3} toggle={toggle3} className={className}>
                <form onSubmit={handleSubmitAction}>
                    ...
                    <ModalBody>
                        <Row>
                            <Col lg={12}>
                                <label>Submission : {summarydetails.submission}</label>
                                <br />
                                <label>Interview : {summarydetails.interview}</label>
                                <br />
                                <label>Offer : {summarydetails.offer}</label>
                                <br />
                                <label>Start : {summarydetails.start}</label>
                                <br />
                                <label>BD : {summarydetails.bd}</label>
                                <br />
                            </Col>
                        </Row>
                    </ModalBody>
