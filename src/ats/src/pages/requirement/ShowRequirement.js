        ...
        <React.Fragment>
           ...
           <Col className="text-right" lg={12}><button className="btn btn-secondary bg-secondary upbtn  mr-0" onClick={props.goBackToRequirement}>Go Back To Requirement</button></Col>
                <Col lg={6} className="mt-2">
                  ...
                  <label className="col-sm-12"><b>Relevant Experience :</b> {showrdt.jrelmax} Years&nbsp; To &nbsp;{showrdt.jrelmin} Years</label>
                </Col>
                <Col lg={6}>
                  <label className="col-sm-12"><b>Category :</b> {showrdt.jcategory}</label>
                  <label className="col-sm-12"><b>Type :</b> {showrdt.jtype}</label>
                  <label className="col-sm-12"><b>Employment Type :</b> {showrdt.jemployementtyp}</label>
